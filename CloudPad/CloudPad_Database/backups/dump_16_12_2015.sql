...
--
-- Temporary view structure for view `all_personal_pronouns`
--

DROP TABLE IF EXISTS `all_personal_pronouns`;
/*!50001 DROP VIEW IF EXISTS `all_personal_pronouns`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `all_personal_pronouns` AS SELECT 
 1 AS `language`,
 1 AS `phrase`,
 1 AS `sex`,
 1 AS `formal`,
...
INSERT INTO `boodschappen_product` VALUES (86,'Path̩',3,''),(87,'keukenrol',1,'3 laags'),(88,'Beschuit',3,''),(89,'Peperkoek',1,''),(90,'Aarbeien jam',2,'Hero original aardbeien'),(91,'Brinta',2,''),(92,'(braad)boter',4,'2 braadboter blue band en 2 becelboter'),(93,'(school)koeken',3,''),(94,'Optimel',1,'Aardbei of banaan, 1,5L'),(95,'schuifspeldjes',1,'zakje van  ongeveer 10?'),(97,'afwasmiddel',1,'huismerk'),(100,'vanille kwark voor papa',1,'');
/*!40000 ALTER TABLE `boodschappen_product` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `donny_article`
--

DROP TABLE IF EXISTS `donny_article`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `donny_article` (
  `id` int(11) NOT NULL,
  `singular` varchar(45) NOT NULL,
  `plural` varchar(45) NOT NULL,
  `sex` tinyint(1) NOT NULL,
  `is_definite` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `donny_article`
--

LOCK TABLES `donny_article` WRITE;
/*!40000 ALTER TABLE `donny_article` DISABLE KEYS */;
INSERT INTO `donny_article` VALUES (9,'een','de',0,0),(10,'een','de',1,0),(11,'een','de',2,0),(12,'het','het',0,1),(13,'de','de',1,1),(14,'de','de',2,1);
/*!40000 ALTER TABLE `donny_article` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `donny_noun` VALUES (5,'boom',1),(6,'aap',1),(7,'schaap',0);
/*!40000 ALTER TABLE `donny_noun` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `donny_personal_pronoun`
--

DROP TABLE IF EXISTS `donny_personal_pronoun`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `donny_personal_pronoun` (
  `id` int(11) NOT NULL,
  `sex` varchar(20) NOT NULL,
  `formal` tinyint(1) NOT NULL,
  `first_person_singular` varchar(20) NOT NULL,
  `second_person_singular` varchar(20) NOT NULL,
  `third_person_singular` varchar(20) NOT NULL,
  `first_person_plural` varchar(20) NOT NULL,
  `second_person_plural` varchar(20) NOT NULL,
  `third_person_plural` varchar(20) NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `personal_pronoun_word_fk` FOREIGN KEY (`id`) REFERENCES `donny_word` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `donny_personal_pronoun`
--

LOCK TABLES `donny_personal_pronoun` WRITE;
/*!40000 ALTER TABLE `donny_personal_pronoun` DISABLE KEYS */;
INSERT INTO `donny_personal_pronoun` VALUES (8,'1',0,'ik','jij','hij','wij','jullie','zij');
/*!40000 ALTER TABLE `donny_personal_pronoun` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `donny_phrase` VALUES (4,'ignored_phrase'),(3,'lijdend_voorwerp'),(2,'onderwerp'),(1,'persoonsvorm'),(5,'test_purposes_1'),(6,'test_purposes_2'),(7,'test_purposes_3'),(8,'test_purposes_4'),(9,'test_purposes_5'),(10,'test_purposes_6'),(11,'test_purposes_7');
...
INSERT INTO `donny_position` VALUES (1,1,4,1),(2,1,2,2),(3,1,1,3),(4,2,1,1),(5,2,4,2),(6,2,2,3);
...
CREATE TABLE `donny_syntax` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `sentence_type_UNIQUE` (`sentence_type`)
...
INSERT INTO `donny_syntax` VALUES (1,'normale_zin'),(2,'vraagzin');
...
INSERT INTO `donny_verb` VALUES (1,'lopen','loop','loopt','loopt','lopen','lopen','lopen'),(2,'praten','praat','praat','praat','praten','praten','praten'),(3,'neuken','neuk','neukt','neukt','neuken','neuken','neuk'),(4,'roepen','roep','roept','roept','roepen','roepen','roepen');
...
INSERT INTO `donny_word` VALUES (1,'dutch'),(2,'dutch'),(3,'dutch'),(4,'dutch'),(5,'dutch'),(6,'dutch'),(7,'dutch'),(8,'dutch'),(9,'dutch'),(10,'dutch'),(11,'dutch'),(12,'dutch'),(13,'dutch'),(14,'dutch');
...
INSERT INTO `donny_word_phrase` VALUES (1,1),(1,2),(1,3),(1,4),(2,5),(2,6),(2,7),(3,8),(4,9),(4,10),(4,11),(4,12),(4,13),(4,14);
...
/*!50001 VIEW `all_articles` AS select `w`.`language` AS `language`,`p`.`name` AS `phrase`,`a`.`singular` AS `singular`,`a`.`plural` AS `plural`,`a`.`sex` AS `sex`,`a`.`is_definite` AS `is_definite` from (((`donny_article` `a` join `donny_word` `w`) join `donny_word_phrase` `wp`) join `donny_phrase` `p`) where ((`a`.`id` = `w`.`id`) and (`w`.`id` = `wp`.`word_id`) and (`wp`.`phrase_id` = `p`.`id`)) */;
...
--
-- Final view structure for view `all_personal_pronouns`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`dbi324201`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `all_personal_pronouns` AS select `w`.`language` AS `language`,`p`.`name` AS `phrase`,`n`.`sex` AS `sex`,`n`.`formal` AS `formal`,`n`.`first_person_singular` AS `first_person_singular`,`n`.`second_person_singular` AS `second_person_singular`,`n`.`third_person_singular` AS `third_person_singular`,`n`.`first_person_plural` AS `first_person_plural`,`n`.`second_person_plural` AS `second_person_plural`,`n`.`third_person_plural` AS `third_person_plural` from (((`donny_personal_pronoun` `n` join `donny_word` `w`) join `donny_word_phrase` `wp`) join `donny_phrase` `p`) where ((`n`.`id` = `w`.`id`) and (`w`.`id` = `wp`.`word_id`) and (`wp`.`phrase_id` = `p`.`id`)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2015-12-16 22:01:11
