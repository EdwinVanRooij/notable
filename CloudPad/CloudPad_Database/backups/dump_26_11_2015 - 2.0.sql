...
INSERT INTO `note` VALUES (367,'','','1','2015-11-26 19:12:05','2015-11-26 19:12:27',4);
...
FOR EACH ROW
BEGIN
	insert into share (account_id, note_id) values (new.owner_id, (select max(id) from note));
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
INSERT INTO `share` VALUES (4,367);
...
-- Dump completed on 2015-11-26 20:18:17
