 ...
 */
public class AdapterItemInfoAccount extends AbstractItem<AdapterItemInfoAccount, AdapterItemInfoAccount.ViewHolder> {
    private Account account;

    public AdapterItemInfoAccount(Account a) {
        this.account = a;
    }
